...
public class MateGroup implements Serializable {
	...
	@XmlElement(required = true, nillable = false, name = "speciality")
	private String speciality;
	@XmlElement(name = "maximal amount of students")
	private int maxNumberOfStudents;
	private int id;

	public MateGroup(Person teacher, List<Person> students, Room room, Set<HumanResource> humanResources, String soeciality, int maxNumberOfStudents) {
		this.teacher = teacher;
		this.students = students;
		this.room = room;
		this.humanResources = humanResources;
		this.speciality = soeciality;
	...
	public String getSoeciality() {
		return speciality;
	}

	public void setSoeciality(String soeciality) {
		this.speciality = soeciality;
	}
	...
	public static MateGroup mateGroupExampleCreator() {
		...
		Room room = new Room("Kiyv", "Tarasivska", 16, 28, new RoomOwner("Valera", "Valerovich", 1968));
		...
		mateGroup.setSoeciality("Java");
		mateGroup.setMaxNumberOfStudents(10);
